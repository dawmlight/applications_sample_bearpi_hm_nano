...
进入代码仓库主页：[https://gitee.com/sample/bearpi_hm_nano](https://gitee.com/sample/bearpi_hm_nano)，选择需要克隆的代码仓库，执行命令，如：

```
git clone https://gitee.com/sample/bearpi_hm_nano.git -b master
```
## 编译源码
